...
var=$(fio --name=randread --ioengine=libaio --iodepth=2 --rw=randread --bs=4k --direct=0 --size=16M --numjobs=1 --runtime=10 --group_reporting | grep aggrb | awk '{printf $3}' | sed 's/[^0-9]//g')
