...
while [ $SECONDS -lt $end ]; do
    ...
    result=$(timeout $time_left fio --name=randread --ioengine=libaio --iodepth=2 --rw=randread --bs=4k --direct=0 --size=16M --numjobs=1 --runtime=15 --group_reporting | grep READ | awk '{printf $2}' | sed 's/[^0-9.]//g')
