...
var=$(sudo fio --name=randread --ioengine=libaio --iodepth=4 --rw=randread --bs=4k --direct=0 --size=32M --numjobs=1 --runtime=15 --group_reporting | grep aggrb | awk '{printf $3}' | sed 's/[^0-9]//g')
